...
vim.opt.fillchars = { eob = "󰜥" } -- Disable `~` on nonexistent lines.
...
vim.opt.scrolloff = 11 -- Number of lines to leave before/after the cursor when scrolling. Setting a high value keep the cursor centered.
